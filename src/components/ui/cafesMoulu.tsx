        ...
        <div className="bg-white shadow-sm">
          <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <p className="text-lg text-gray-600 text-center mt-4">
              Découvrez notre collection complète de cafés moulu du monde entier avec une qualité exceptionnelle. Tous nos cafés sont soigneusement sélectionnés pour vous offrir des saveurs uniques et des expériences inoubliables.
            </p>
          </div>
        </div>
