...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center text-md font-medium disabled:pointer-events-none text-accent-foreground data-[state=open] cursor-pointer"
)
